...
export default function Registration() {
  ...
  const collectData = async (e) => {
    ...
    if (!isValid) {
      // If any field is empty or passwords don't match or don't meet the length and complexity requirements, stop form submission
      return;
    }
        ...
        <div className="col-md-6 column2">
          <form onSubmit={collectData} className="registration-form">
            ...
            <p>
              ...
              <span>
                <a href="/" style={{ borderColor: "#2D9596" }}>
                  Sign In
                </a>
              </span>
            </p>
