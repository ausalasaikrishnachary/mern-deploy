    ...
    if (validateForm()) {
      try {
        ...
        if (response.ok) {
          ...
          // Navigate to the display page or another destination
          navigate('/Dashboard'); // Ensure that '/login' is the correct path
        } else {
        ...
        <div className="col-md-6">
          <form className="form-container" onSubmit={handleSubmit}>
            ...
            <p>
              Create an Account{' '}
              <span>
                <a href="/Registration" style={{ borderColor: '#2D9596' }}>
                  Sign Up
                </a>
              </span>
            </p>
